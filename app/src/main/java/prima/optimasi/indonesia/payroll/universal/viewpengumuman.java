...
public class viewpengumuman extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        prima.optimasi.indonesia.payroll.utils.Tools.setSystemBarColor(this, R.color.grey_5);
        prima.optimasi.indonesia.payroll.utils.Tools.setSystemBarLight(this);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_article_share_save, menu);
        prima.optimasi.indonesia.payroll.utils.Tools.changeMenuIconColor(menu, getResources().getColor(R.color.grey_60));
        return true;
    }
