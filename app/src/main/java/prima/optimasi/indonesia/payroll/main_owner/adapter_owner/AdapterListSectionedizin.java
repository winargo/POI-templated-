...
public class AdapterListSectionedizin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListSectionedizin(Context context, List<datacuti> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            view.tglawal.setText("Tanggal Mulai Izin");
            view.tglakhir.setText("Tanggal Akhir Izin");
            view.tglakhirdata.setText(p.getTglakhir());
            view.tglawaldata.setText(p.getTglmulai());
            view.keterangan.setText("Keterangan Izin");
            view.keterangandata.setText(p.getKeterangan());
            view.hari.setText("Waktu Izin");
