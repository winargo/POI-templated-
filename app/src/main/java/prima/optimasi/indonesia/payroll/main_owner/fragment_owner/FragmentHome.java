...
public class FragmentHome extends Fragment {
    ...
    ImageButton expand, expand2, expand3;
    LinearLayout lyt_parent, lyt_parent2, lyt_parent3;
    LinearLayout lyt_expand, lyt_expand2, lyt_expand3;
    TextView sisakontrakkerja, sisakontrakkerja2, sisakontrakkerja3;
    ...
    boolean expansi=false, expansi2=false, expansi3=false;
    @Override
                    ...
                    try {
                        ...
                        for (int i = 0; i < pengsarray.length(); i++) {
                            ...
                            if(i+1==pengsarray.length()){
                                sisakontrakkerja.setText("("+banyak+" orang)");
                    ...
                    try {
                        ...
                        for (int i = 0; i < pengsarray.length(); i++) {
                            ...
                            /*
                                ...
                                if(i+1==pengsarray.length()){
                                    sisakontrakkerja2.setText("("+banyak+" orang)");
                    ...
                    try {
                        ...
                        for (int i = 0; i < pengsarray.length(); i++) {
                            ...
                            /*
                                ...
                                if(i+1==pengsarray.length()){
                                    sisakontrakkerja3.setText("("+banyak+" orang)");
