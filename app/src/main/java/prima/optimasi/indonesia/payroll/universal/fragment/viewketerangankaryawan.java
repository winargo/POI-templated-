...
public class viewketerangankaryawan extends Fragment {

    public viewketerangankaryawan() {
    }

    private String title;
    private static final String ARG_TITLE="title";
    public static viewketerangankaryawan newInstance(String title) {
        Bundle args=new Bundle();
        args.putString(ARG_TITLE, title);

        viewketerangankaryawan fragment = new viewketerangankaryawan();
