...
public class AdapterListSectionedsakit extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListSectionedsakit(Context context, List<datacuti> items, int animation_type) {
        this.items = items;
        ctx = context;
