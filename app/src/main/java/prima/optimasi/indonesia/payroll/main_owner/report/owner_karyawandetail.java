...
public class owner_karyawandetail extends AppCompatActivity {
    ...
    private AdapterListSectionedsakit mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pd.setTitle("Loading Data Karyawan");
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Report Sakit");
    ...
    private class retrivecuti extends AsyncTask<Void, Integer, String>
    {
        ...
        String urldata = generator.sakiturl;
        String passeddata = "" ;
            ...
            try {
                ...
                if (result != null) {
                    try {
                        ...
                        mAdapter = new AdapterListSectionedsakit(owner_karyawandetail.this, items, ItemAnimation.LEFT_RIGHT);

                        recyclerView.setLayoutManager(new GridLayoutManager(owner_karyawandetail.this, 1));
