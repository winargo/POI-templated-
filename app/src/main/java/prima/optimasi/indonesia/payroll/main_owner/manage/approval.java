...
public class approval extends AppCompatActivity implements adapterapprovalhelper.RecyclerItemTouchHelperListener {
    ...
    private SwipeRefreshLayout refresh_approvalfocus;

    private RecyclerView recyclerView;

    List<listjobextension> listdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        refresh_approvalfocus = findViewById(R.id.refresh_approvalfocus);
        ...
        refresh_approvalfocus.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                ...
                for (int i = 0 ; i < options.length;i++){
                    if(options[i].equals(getIntent().getStringExtra("tipe"))){
                        initToolbar(options[i]);
                        reretrive adddata = new reretrive(approval.this,options[i],parent_view);
                        adddata.execute();
                    }
                }
            }
    ...
    private class reretrive extends AsyncTask<Void, Integer, String>
    {
        String response = "";
        String error = "";
        String username=  "" ;
        ...
        public reretrive(Context context,String choice,CoordinatorLayout coor)
        {
            prefs = context.getSharedPreferences("poipayroll",Context.MODE_PRIVATE);
        ...
        protected void onPostExecute(String result1) {
            ...
            try {
                ...
                if (result != null) {
                    ...
                    refresh_approvalfocus.setRefreshing(false);
                    //ItemTouchHelper.SimpleCallback itemTouchHelperCallback = new adapterapprovalhelper(0, ItemTouchHelper.LEFT , approval.this);
                    //new ItemTouchHelper(itemTouchHelperCallback).attachToRecyclerView(recyclerView);
