...
public class owner_sakit extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pd.setTitle("Loading Data Sakit");
            ...
            try {
                ...
                if (result != null) {
                    try {
                        ...
                        mAdapter = new AdapterListSectionedsakit(owner_sakit.this, items, ItemAnimation.LEFT_RIGHT);

                        recyclerView.setLayoutManager(new GridLayoutManager(owner_sakit.this, 1));
