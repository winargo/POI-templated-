package prima.optimasi.indonesia.payroll.universal.fragment;
...
import prima.optimasi.indonesia.payroll.universal.absence.AutoFitTextureView;
import prima.optimasi.indonesia.payroll.universal.absence.OverlayView;
...
public class facedetectionfragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fr_layout, container, false);
    }

    @Override
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.preview_camera);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("App Require Camera Permission")
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
           /* for(final String cameraId : manager.getCameraIdList()){
            ...
            ErrorDialog.newInstance("Your Device is Not Supported")
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }

    /**
     * Opens the camera specified by {@link facedetectionfragment#mCameraId}.
     */
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("App Require Camera Permission")
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
