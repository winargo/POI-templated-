...
public class AdapterListSectionedgajesti extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListSectionedgajesti(Context context, List<datagajiperiode> items) {
        this.items = items;
        ctx = context;
    }

    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        public TextView tanggal1,tanggal2,potongantelat,makan,transport,totalbersih,totalkotor;
        ...
        public OriginalViewHolder(View v) {
            ...
            totalkotor = v.findViewById(R.id.gajikerjahari);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_report_list_pengajian_esti, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            view.totalkotor.setText("Rp "+formatter.format(p.getTotalgaji()));
            ...
            view.transport.setText("Rp "+formatter.format(p.getPunishment()));
            view.transport.setTextColor(Color.GREEN);

            view.makan.setText("Rp "+formatter.format(p.getReward()));
            view.makan.setTextColor(ctx.getResources().getColor(R.color.green_700));
