    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        stateCallback = new CameraDevice.StateCallback() {
            ...
            public void onOpened(CameraDevice cameraDevice) {
                facecapture.this.cameraDevice = cameraDevice;
            ...
            public void onDisconnected(CameraDevice cameraDevice) {
                cameraDevice.close();
                facecapture.this.cameraDevice = null;
            }
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                facecapture.this.cameraCaptureSession = cameraCaptureSession;
                                facecapture.this.cameraCaptureSession.setRepeatingRequest(captureRequest,
